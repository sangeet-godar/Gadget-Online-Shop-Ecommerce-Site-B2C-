				...
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table">
								...
								<tbody>
									<?php
									$res=mysqli_query($con,"select distinct(order_detail.id) ,order_detail.*,products.product_name,products.image,`order`.address,`order`.city,`order`.pincode from order_detail,products ,`order` where order_detail.order_id='$order_id' and  order_detail.product_id=products.id GROUP by order_detail.id");
									$total_price=0;
