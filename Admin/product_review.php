...
$sql = "select users.username,users.email,product_review.id,product_review.product_rating,product_review.review,product_review.added_on,product_review.status,products.product_name as pname from users,product_review,products where product_review.user_id=users.id and product_review.product_id=products.id order by product_review.added_on desc";
