...
<section class="htc__contact__area ptb--100 bg__white">
	...
	<div class="col-xs-8 ">
		...
		$profile_res = mysqli_query($con, "select * from users where users.id='$uid'");
		...
		?>
			...
			<div class="profile_div">
				<label>Phone:&nbsp;&nbsp;<?php echo $row['mobile'] ?></label>
			</div>
			<div class="profile_div">
				<label>User since:&nbsp;&nbsp;
					<?php
...
<script>
	...
	function update_password() {
		...
		if (new_password != '' && confirm_new_password != '' && new_password != confirm_new_password) {
			jQuery('#confirm_new_password_error').html('Please enter same new password');
			is_error = 'yes';
		}
