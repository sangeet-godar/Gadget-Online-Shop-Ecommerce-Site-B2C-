...
$res=mysqli_query($con,"select products.product_name,products.image,products.price,products.mrp,wishlist.id from products,wishlist where wishlist.product_id=products.id and wishlist.user_id='$uid'");
?>
